<script>
    ...
    onMount(function() {
        currentVersionCursus.set("v2.0.0ltr")
        currentVersionCurode.set("v2.0.0ltr")
        currentVersionCurush.set("v1.1.2")
    })
</script>
...
<footer>
    <p>&copy; {new Date().getFullYear()} CursusDB, all rights reserved.</p>
